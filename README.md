...
Увага! Цей репозиторій, наразі, не є офіційним для програми "ZvitOK". Він створений виключно для збереження архівної версії програми ZvitOk та розвитку доповнення ZvitOkPlus.
Нагадую, сторінка підтримки що вказана в програмі ZvitOk давно не працює, і немає контакту з оригінальним розробником.
