...
Тека \Data\Themes містить одну систему тему \System та теки зі звичайними налаштованими темами оформлення. Кожна тема має файл налаштувань theme.json та підпапку \Icon з іконками.
Звичайні теми наслідують параметри системної теми, та змінюють ії за необхідності. 
