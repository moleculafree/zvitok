...
17. Можливіть використання окремих шаблонів розмітки звітів для формування PDF файлів [XSL-FO](#XSL-FO).
18. Можливіть скопіювати список Термін дії ЕЦП з Налаштування параметрів програми [Експорт списків](#Експорт-списків).
19. Автоматично зберігає стан опцій та шляхи до ключів/підписів.
...
### XSL-FO ###
> [!NOTE]  
> доступно, починаючи з версії 13.

Тека завантаження \Data\Templates\  

Для створення PDF-файлів друку звітів використовуються файли розмітки формату .FO.  
