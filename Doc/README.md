...
> [!NOTE]
> ZvitOkPlus використовує новий формат збереження даних, тому якщо ви запустите старий ZvitOk, ви не побачите внесені зміни<sup>але є нюанс</sup>
...
Якщо в Налаштуваннях ця опція увімкнена, оновлення виконується автоматично після натискання кнопки "Завантажити сертифікати".
...
1. **Закрийте програму до внесення змін у файл.**  
2. Відкрийте файл \Data\custom.ini та додайте в розділ [General] наступний рядок
```
DebugLog=1
```
...
За замовчуванням програма використовує усі dll бібілотеки початкового проекту ZvitOk.  
