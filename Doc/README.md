...
Після активації режиму DebugLog і запуску програми буде створено файл \Logs\debug-<поточна дата>.log . Дані з файлу можна використати для відстеження помилок в роботі.  
Режим DebugLog автоматично вимикається (видаляється DebugLog з файлу) після завершення роботи програми. 
