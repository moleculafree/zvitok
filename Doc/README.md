...
Журнал роботи програми можна ввімкнути лише через файл.  
...
Рядок DebugLog автоматично видалиться після завершення роботи програми. Для його увімкнення повторно додайте рядок у файл.
